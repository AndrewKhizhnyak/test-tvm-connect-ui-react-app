...
// ../../node_modules/everscale-inpage-provider/dist/adapters.js
var require_adapters = __commonJS({
  "../../node_modules/everscale-inpage-provider/dist/adapters.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.isProviderAdapter = exports.FallbackProviderAdapter = exports.SparxProviderAdapter = exports.EverscaleProviderAdapter = exports.StaticProviderAdapter = exports.hasEverscaleProvider = void 0;
    var isBrowser = typeof window !== "undefined" && typeof window.document !== "undefined";
    var ensurePageLoaded = !isBrowser || document.readyState === "complete" ? Promise.resolve() : new Promise((resolve) => window.addEventListener("load", () => resolve()));
    function hasEverscaleProvider() {
      if (!isBrowser)
        return Promise.resolve(false);
      return ensurePageLoaded.then(() => window.__hasEverscaleProvider === true);
    }
    exports.hasEverscaleProvider = hasEverscaleProvider;
    var StaticProviderAdapter = class {
      constructor(provider) {
        this._provider = provider;
      }
      getProvider() {
    ...
    exports.StaticProviderAdapter = StaticProviderAdapter;
    var EverscaleProviderAdapter = class {
      async getProvider() {
        ...
        return new Promise((resolve) => {
          if (window.__ever) {
            ...
            window.addEventListener("ever#initialized", (_) => resolve(window.__ever), { once: true });
          }
        });
      }
      hasProvider() {
    ...
    exports.EverscaleProviderAdapter = EverscaleProviderAdapter;
    var SparxProviderAdapter = class {
      async getProvider() {
        if (!await this.hasProvider())
          return;
        return new Promise((resolve) => {
          if (window.__sparx) {
            ...
            window.addEventListener("sparx#initialized", (_) => resolve(window.__sparx), { once: true });
          }
        });
      }
      hasProvider() {
    ...
    exports.SparxProviderAdapter = SparxProviderAdapter;
    var FallbackProviderAdapter = class {
      constructor(adapter, ...fallbacks) {
      ...
      async hasProvider() {
        for (const adapter of this._adapters) {
          if (await adapter.hasProvider())
            return true;
        }
        return false;
      }
    };
    exports.FallbackProviderAdapter = FallbackProviderAdapter;
    function isProviderAdapter(value) {
      return !!value && "getProvider" in value && "hasProvider" in value;
    }
    exports.isProviderAdapter = isProviderAdapter;
  }
});
...
var require_dist = __commonJS({
  "../../node_modules/everscale-inpage-provider/dist/index.js"(exports) {
    ...
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.ProviderNotInitializedException = exports.ProviderNotFoundException = exports.ProviderRpcClient = exports.LT_COLLATOR = exports.isAddressObject = exports.mergeTransactions = exports.MessageExpiredException = exports.AddressLiteral = exports.Address = exports.Subscriber = void 0;
    var models_1 = require_models();
    var utils_1 = require_utils();
    ...
    function getAdapter(properties) {
      if (!properties.provider)
        return new adapters_1.EverscaleProviderAdapter();
      return (0, adapters_1.isProviderAdapter)(properties.provider) ? properties.provider : new adapters_1.StaticProviderAdapter(properties.provider);
    }
      ...
      async computeStorageFee(args) {
        ...
        return await this._api.computeStorageFee({
          state: {
            ...
            lastTransactionId: args.state.lastTransactionId != null ? { ...args.state.lastTransactionId } : void 0,
