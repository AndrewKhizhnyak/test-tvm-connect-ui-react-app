...
*/
export function parseFullAccountStateInit(account: string): string | undefined;
/**
* @param {string} config
* @param {string} account
* @param {number} utime
...
*/
export function computeStorageFee(config: string, account: string, utime: number, is_masterchain: boolean): StorageFeeInfo;
/**
* @param {string} config
* @param {string} account
...
*/
  constructor(sender: IJrpcSender);
}
/**
*/
...
*/
  constructor(sender: IProtoSender);
}
/**
*/
...
*/
  constructor(proxy_connector: IProxyConnector);
}
/**
*/
...
* @returns {Transport}
*/
  static fromGqlConnection(gql: GqlConnection, clock: ClockWithOffset): Transport;
/**
* @param {JrpcConnection} jrpc
* @param {ClockWithOffset} clock
* @returns {Transport}
*/
  static fromJrpcConnection(jrpc: JrpcConnection, clock: ClockWithOffset): Transport;
/**
* @param {ProtoConnection} proto
* @param {ClockWithOffset} clock
* @returns {Transport}
*/
  static fromProtoConnection(proto: ProtoConnection, clock: ClockWithOffset): Transport;
/**
* @param {ProxyConnection} proxy
* @param {ClockWithOffset} clock
* @returns {Transport}
*/
  static fromProxyConnection(proxy: ProxyConnection, clock: ClockWithOffset): Transport;
/**
...
export interface InitOutput {
  ...
  readonly __wbg_proxyconnection_free: (a: number, b: number) => void;
  readonly __wbg_transport_free: (a: number, b: number) => void;
  readonly transport_fromGqlConnection: (a: number, b: number) => number;
  readonly transport_fromJrpcConnection: (a: number, b: number) => number;
  readonly transport_fromProtoConnection: (a: number, b: number) => number;
  readonly transport_fromProxyConnection: (a: number, b: number) => number;
  ...
  readonly parseFullAccountStateInit: (a: number, b: number, c: number) => void;
  readonly computeStorageFee: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
  ...
  readonly proxyconnection_new: (a: number) => number;
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h0fff6d0ad1f7528f: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h5874b044d3e8a56e: (a: number, b: number, c: number, d: number) => void;
}
